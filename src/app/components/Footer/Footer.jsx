      ...
      <div className="flex w-screen flex-col px-6 pt-10 lg:px-8 xl:px-32">
          ...
          <div className="mt-7 max-w-[700px] grow lg:flex lg:flex-row">
            ...
            <div className="flex grow flex-row flex-wrap lg:flex-nowrap lg:items-start">
              ...
              <div className="my-5 mr-8 flex max-w-[500px] grow basis-[100px] flex-col space-y-5 lg:my-0">
                <h2 className="font-inter font-medium">SERVICES</h2>
                <Link
                  href=""
                  className="font-inter font-light hover:underline hover:text-purple-800 text-slate-800"
                >
                  Coin Development
                </Link>
                <Link
              ...
              {/* <!-- LINK BLOCK --> */}
              <div className="my-5 mr-8 flex max-w-[500px] grow basis-[100px] flex-col space-y-5 lg:my-0">
                <h2 className="font-inter font-medium">NFT</h2>
                <Link
                  href=""
                  className="font-inter font-light hover:underline hover:text-purple-800 text-slate-800"
                >
        ...
        <div className="mt-20 lg:flex lg:flex-row-reverse lg:justify-between">
          ...
          <div className="mb-8 mt-6 flex flex-row lg:mb-0 lg:mt-0">
            <Link href="" className="mr-4 transition hover:text-purple-900">
              <svg
            ...
            <Link href="" className="mx-4 transition hover:text-purple-900">
              <svg
                className="fill-current"
                width="24"
                height="24"
          ...
          <p className="font-inter text-sm text-slate-800 lg:mt-0">
